...
| Requirement          | Details                                                                                                                  |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Operating System** | Ubuntu 22.04 LTS (recommended); Debian 12 (Bookworm) or 13 (Trixie); macOS Ventura (13) or later; or WSL2 on Windows     |
| **Infrastructure**   | Cloud VM with SSH access; minimum 2 GB RAM recommended                                                                   |
| **Docker**           | Docker Engine v25 or above (v29 recommended); Docker Compose v2.x. Versions below v25 are end of life and not supported. |
