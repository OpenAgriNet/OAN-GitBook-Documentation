...
BharatVISTAAR is a national-scale implementation of OpenAgriNet (OAN) that enables AI-powered agricultural services across India. It builds on the same architectural principles of open networks as MahaVISTAAR, which was developed for Maharashtra, and extends the model to support agricultural ecosystems nationwide.
...
![BharatVISTAAR Architecture](../../.gitbook/assets/bharat-vistaar.png)
